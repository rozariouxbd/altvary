 ...
 * The core five run on RFME + orders. R06 (product exhaustion) needs line-item +
 * product-volume data and is gated behind SKINCARE_FEATURES_ENABLED.
 */
export const REGISTRY: PlayDefinition[] = [
  R02, R04, R05, R07, R08,
  ...(SKINCARE_FEATURES ? [R06] : []),
];
